...
import game.objects.items.Wall;
...
public class MapBodyBuilder {
    ...
    public static Vector2 playerLoc=new Vector2(10,7);
    ...
    public static void buildObjects(Map map,PlayState state){
    	...
    	for(MapObject obj : tl.getObjects()){
    		...
    		if(object.getTile().getProperties().get("type").equals("box")){
    			state.addObj(new Box(state,new Vector2(object.getX()/ppt,object.getY()/ppt)));
    		
    		}else if(object.getTile().getProperties().get ("type").equals("health")){
    			state.addObj(new Pickable(state,new Vector2(object.getX()/ppt,object.getY()/ppt),Pickable.HEALTH));
    			
    		}else if(object.getTile().getProperties().get("type").equals("ammo")){
    			state.addObj(new Pickable(state,new Vector2(object.getX()/ppt,object.getY()/ppt),Pickable.AMMO));
    			
    		}else if(object.getTile().getProperties().get("type").equals("player")){
    			playerLoc=new Vector2(object.getX()/ppt,object.getY()/ppt);
    		}
    	}
    }
